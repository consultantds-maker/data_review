...
page_5 = st.Page(r"tier_1.py", title="Hazard", icon="❄️")
page_2 = st.Page(r"tier_2.py", title="Exposure", icon="❄️")
page_3 = st.Page(r"tier_3.py", title="Vulnerability", icon="❄️")
page_4 = st.Page(r"tier_4.py", title="Ceri", icon="❄️")
